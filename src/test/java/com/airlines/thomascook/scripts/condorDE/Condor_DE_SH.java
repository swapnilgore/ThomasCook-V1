 ...
 */
public class Condor_DE_SH extends Reusables_DE implements OR_HomePage,OR_FlightDetails {

    LinkedHashMap<String,String> testData= new LinkedHashMap<String,String>();
    @Test
    public void PMI() throws Throwable {
        logger=extent.startTest("Condor_DE_SH");
        testData=getExcelData(System.getProperty("user.dir")+"\\TestData\\TestData.xls","TCTestData","PMI");
        alertAccept(true);
